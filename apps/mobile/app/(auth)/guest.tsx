...
/** Gap between CTA and keyboard when open; resting bottom pad uses safe area. */
...
export default function GuestSetupScreen() {
  ...
  return (
    <SafeAreaView edges={["top"]} className="flex-1 bg-background">
      ...
      {/* Bottom inset must live on the CTA row itself — KeyboardStickyView
          offset alone does not reliably clear the home indicator when the
          keyboard is closed on newer iOS. */}
      <KeyboardStickyView
        offset={{
          closed: 0,
      ...
      >
        <View
          className="px-6 pt-2"
          style={{ paddingBottom: Math.max(insets.bottom, CTA_KEYBOARD_GAP) }}
        >
